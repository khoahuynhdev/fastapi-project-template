...
- 🎯 Entry points to execute your program using `python -m <fastify_project_template>` or `$ fastify_project_template` with basic CLI argument parsing.
...
---
# fastify_project_template

[![codecov](https://codecov.io/gh/khoahuynhdev/fastify-project-template/branch/main/graph/badge.svg?token=fastify-project-template_token_here)](https://codecov.io/gh/khoahuynhdev/fastify-project-template)
[![CI](https://github.com/khoahuynhdev/fastify-project-template/actions/workflows/main.yml/badge.svg)](https://github.com/khoahuynhdev/fastify-project-template/actions/workflows/main.yml)

Awesome fastify_project_template created by khoahuynhdev

## Install

from source
```bash
git clone https://github.com/khoahuynhdev/fastify-project-template fastify_project_template
cd fastify_project_template
make install
```
...
```bash
pip install fastify_project_template
```

## Executing

```bash
$ fastify_project_template run --port 8080
```

or

```bash
python -m fastify_project_template run --port 8080
```

or

```bash
$ uvicorn fastify_project_template:app
```

## CLI

```bash
❯ fastify_project_template --help
Usage: fastify_project_template [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastify_project_template create-user --help
Usage: fastify_project_template create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastify_project_template create-user admin admin --superuser
```
...
```bash
❯ fastify_project_template shell       
...
Run with `fastify_project_template run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastify_project_template create-user`.
...
-----------------------------------------------------
fastify_project_template/__init__.py              4      0   100%
fastify_project_template/app.py                  16      1    94%
fastify_project_template/cli.py                  21      0   100%
fastify_project_template/config.py                5      0   100%
fastify_project_template/db.py                   10      0   100%
fastify_project_template/models/__init__.py       0      0   100%
fastify_project_template/models/content.py       47      1    98%
fastify_project_template/routes/__init__.py      11      0   100%
fastify_project_template/routes/content.py       52     25    52%
fastify_project_template/routes/security.py      15      1    93%
fastify_project_template/routes/user.py          52     26    50%
fastify_project_template/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastify_project_template/default.toml.
