...
# WARNING: Ensure imports from `fastify_project_template` comes after this line
from fastify_project_template import app, settings, db  # noqa
from fastify_project_template.cli import create_user, cli  # noqa
